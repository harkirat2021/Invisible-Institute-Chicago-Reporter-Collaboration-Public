...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["allegation_vs_salary.csv",new URL("./files/8bd4638d31e8e2f0275ca051a27a7d733b599c4a2f49d253acffa8978bcc598b3a24f998871a7d699da60364ec9c9d0221f067d0c6704991bc251094a4ac1f79",import.meta.url)]]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], function(md){return(
md`# Chicago Police Allegation Count vs. Average Salary 
...
d3.csvParse(await FileAttachment("allegation_vs_salary.csv").text(), ({allegation_count, avg_salary}) => ({name: allegation_count, value: +avg_salary}))
)});
